...
MUTATIONS = [
    ...
    (
        "futexpi",
        "src/proved/futexpi.h",
        "futex_pi_owner_tid",
        "read the flag bits as part of the TID",
    ...
    (
        "futexpi",
        "src/proved/futexpi.h",
        "futex_pi_set_waiters",
        "drop the remainder (a word that already had the bit doubles it away)",
    ...
    (
        "futexpi",
        "src/proved/futexpi.h",
        "futex_pi_mark_owner_died",
        "drop the waiters bit from the death transition",
    ...
    (
        ...
        "src/proved/futexpi.h",
        "futex_pi_unowned",
        "call a word unowned whenever any bit is clear",
    ...
    (
        ...
        "src/proved/futexpi.h",
        "futex_pi_owner_died",
        "read the waiters bit as the death flag",
    ...
    (
        "futexpi",
        "src/proved/futexpi.h",
        "futex_pi_has_waiters",
        "off by one at the boundary word",
        "    return word >= FUTEX_PI_WAITERS;\n",
        "    return word > FUTEX_PI_WAITERS;\n",
    ),
    (
        "futexpi",
        "src/proved/futexpi.h",
        "futex_pi_clear_waiters",
        "clear the death flag along with the waiters bit",
        "    return word % FUTEX_PI_WAITERS;\n",
