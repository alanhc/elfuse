 ...
 * name has to be escaped rather than stored. Not exported: the judgment is
 * observable through casefold_utf16_units, which reports no unit cost for a
 * name the volume will not hold literally.
 */
